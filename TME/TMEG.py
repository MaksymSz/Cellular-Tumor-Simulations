...
plt.xlabel('Time (Days)')
plt.ylabel('Cell Count')
plt.title('Tumor Growth Dynamics Over 250 Days')
plt.yscale('log')
plt.legend()
plt.savefig("tumor_growth_day_250.png")
plt.show()
...
plt.xlabel('X Position')
plt.ylabel('Y Position')
plt.title('2D Spatial Distribution of Tumor Cells - Day 250')
plt.savefig("tumor_distribution_day_250.png")
plt.show()
